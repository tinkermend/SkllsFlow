...
COMMENT ON COLUMN agents.agent_id IS 'AgentID：唯一标识';
...
COMMENT ON COLUMN agents.updated_by IS '更新人ID';
COMMENT ON COLUMN agents.updated_at IS '更新时间';
COMMENT ON COLUMN agents.deleted_by IS '删除人ID';
COMMENT ON COLUMN agents.deleted_at IS '删除时间';
